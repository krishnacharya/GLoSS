...
def finetune(config):
    ...
    model_output_dir = get_llama_modelsave_dir() / f"{model_name.split('/')[-1]}-ft{dataset_name.split('_')[-1]}_ep{num_train_epochs}_maxseq{max_seq_length}_maxsteps{max_steps}"  # this is a pathlib object
