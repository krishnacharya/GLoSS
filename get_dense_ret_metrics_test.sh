...
PYTHON_SCRIPT="/home/kacharya33/nanoGenRec/src/calcirmetrics_denseret_dataset_agno.py"
...
# run_job "sports" "amazon" "llama-8b/Llama-3.1-8B-.json" "$DEFAULT_NUM_SEQUENCES" "test" "$DEFAULT_ENCODER_NAME" "llama-8b" || exit 1